...
More information at https://github.com/senzing/serve-chat
...
More information can be found in the [pkg/github.com/senzing/serve-chat/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/senzing/serve-chat/anotherpackage"
	)
